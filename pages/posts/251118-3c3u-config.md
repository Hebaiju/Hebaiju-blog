...
![1登陆](https://pic1.imgdb.cn/i/0342DZhW2RsFI5kPQYYhBk.png)
...
![选择实例1](https://pic1.imgdb.cn/i/0342DZhII4tndrZKvCbK7S.png)

如图所示，你可以随意去点击，进入任意一个实例终端

![选择实例2](https://pic1.imgdb.cn/i/0342DZhIgD1z89G4dPscNq.png)
...
![3文件管理](https://pic1.imgdb.cn/i/0342DZhWEE5eFhMrXxFaXR.png)
...
![1.4实例设置](https://pic1.imgdb.cn/i/0342DZhXaxQ7y3ZdHaxlbp.png)
...
![2.2.1签到](https://pic1.imgdb.cn/i/0342DZl0LEsv6AwdgubNeY.png)

### 第一步：登陆 [​](#第一步-登陆-1)

[点击该链接](https://app.rainyun.com/account/reward/earn#)直接进入[雨云](https://app.rainyun.com/)的官网。登陆后自动跳转到签到页面。如下图是登陆页面。

![2.1.1登陆](https://pic1.imgdb.cn/i/0342DZmZ2grPjTAFXSuiDq.png)
...
![2.3.1人机验证](https://pic1.imgdb.cn/i/0342DZl97J0MSu7VrRZccU.png)

### 第四步：积分反馈 [​](#第四步-积分反馈)

完成人机验证，随后就可以看到下图红框中的积分增加了**500**分。领取奖励的按钮成为灰色则签到成功。

![2.4.1积分](https://pic1.imgdb.cn/i/0342DZmlub8wkuSA147qII.png)![2.4.2积分](https://pic1.imgdb.cn/i/0342DZkVvli0zQA4RKVbvl.png)
...
![2.5.1续费](https://pic1.imgdb.cn/i/0342DbMEtehOHhi2FIY5vJ.png)
...
![2.6.1密码](https://pic1.imgdb.cn/i/0342DbMHR0SAkFzjHndo67.png)

### 第七步：登陆面板 [​](#第七步-登陆面板)

可以如上图所示点击[（进入控制台(MCSM)）](https://mcsm.rainyun.com/#/login)，再输入上图获取的密码，对面板服务器进行管理。如下图所示。

![2.7.1面板登陆](https://pic1.imgdb.cn/i/0342DbJGxCHGWNt4RU8pKW.png)

### 第八步：登陆控制台 [​](#第八步-登陆控制台)

点击登陆按钮后，如下图页面，再点击进入控制台。

![2.8.1管理面板](https://pic1.imgdb.cn/i/0342DbJ5FrRuHm82QGYmnt.png)

### 第九步：控制台管理 [​](#第九步-控制台管理)

这个时候你就完全登陆进来了，里面所有的东西都可以操作，服务器的开启或者关闭等等一切。

![2.9.1控制台](https://pic1.imgdb.cn/i/0342DbJZThzHT3hWBPOcHq.png)
...
![2.10.1文件管理](https://pic1.imgdb.cn/i/0342DbKZxQSTZxzeHiIyus.png)
