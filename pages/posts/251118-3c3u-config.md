...
![1登陆](https://qntc.hebaiju.cn/img/3c3u1-1.1-login.png)
...
![选择实例1](https://qntc.hebaiju.cn/img/3c3u1-1.1-instance.png)

如图所示，你可以随意去点击，进入任意一个实例终端

![选择实例2](https://qntc.hebaiju.cn/img/3c3u1-1.2-instance.png)
...
![3文件管理](https://qntc.hebaiju.cn/img/3c3u1-1.3-files.png)
...
![1.4实例设置](https://qntc.hebaiju.cn/img/3c3u1-1.4-settings.png)
...
![2.2.1签到](https://qntc.hebaiju.cn/img/3c3u1-2.2.1-checkin.png)

### 第一步：登陆 [​](#第一步-登陆-1)

[点击该链接](https://app.rainyun.com/account/reward/earn#)直接进入[雨云](https://app.rainyun.com/)的官网。登陆后自动跳转到签到页面。如下图是登陆页面。

![2.1.1登陆](https://qntc.hebaiju.cn/img/3c3u1-2.1.1-login.png)
...
![2.3.1人机验证](https://qntc.hebaiju.cn/img/3c3u1-2.3.1-captcha.png)

### 第四步：积分反馈 [​](#第四步-积分反馈)

完成人机验证，随后就可以看到下图红框中的积分增加了**500**分。领取奖励的按钮成为灰色则签到成功。

![2.4.1积分](https://qntc.hebaiju.cn/img/3c3u1-2.4.1-points.png)![2.4.2积分](https://qntc.hebaiju.cn/img/3c3u1-2.4.2-points.png)
...
![2.5.1续费](https://qntc.hebaiju.cn/img/3c3u1-2.5.1-renew.png)
...
![2.6.1密码](https://qntc.hebaiju.cn/img/3c3u1-2.6.1-password.png)

### 第七步：登陆面板 [​](#第七步-登陆面板)

可以如上图所示点击[（进入控制台(MCSM)）](https://mcsm.rainyun.com/#/login)，再输入上图获取的密码，对面板服务器进行管理。如下图所示。

![2.7.1面板登陆](https://qntc.hebaiju.cn/img/3c3u1-2.7.1-panel-login.png)

### 第八步：登陆控制台 [​](#第八步-登陆控制台)

点击登陆按钮后，如下图页面，再点击进入控制台。

![2.8.1管理面板](https://qntc.hebaiju.cn/img/3c3u1-2.8.1-panel.png)

### 第九步：控制台管理 [​](#第九步-控制台管理)

这个时候你就完全登陆进来了，里面所有的东西都可以操作，服务器的开启或者关闭等等一切。

![2.9.1控制台](https://qntc.hebaiju.cn/img/3c3u1-2.9.1-console.png)
...
![2.10.1文件管理](https://qntc.hebaiju.cn/img/3c3u1-2.10.1-files.png)
