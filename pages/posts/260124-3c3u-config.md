...
![MCSM登陆面板0001](https://pic1.imgdb.cn/i/0342DbvtwTXWm9CQVrF9X0.png)
...
![PixPin_2026-02-24_16-48-41.png](https://pic1.imgdb.cn/i/0342DbvZrRtrZkvQmVpm77.png)
...
![PixPin_2026-02-24_18-15-15.png](https://pic1.imgdb.cn/i/0342DbvY6aeIfPMetuWkVi.png)
...
![PixPin_2026-02-24_18-35-36.png](https://pic1.imgdb.cn/i/0342Dbvq2sD5ANBrWg1kDb.png)
...
![PixPin_2026-02-24_20-05-59.png](https://pic1.imgdb.cn/i/0342DbMDvCOjjxBrnqOfzW.png)

其中值得注意的是**环境变量**可以向容器内传递参数，如下图中的参数就能将容器的系统语言修改为中文。从而使MCC获取到的参数修改为中文。该方法在其他的地方仍然适用。

![PixPin_2026-02-24_20-09-10.png](https://pic1.imgdb.cn/i/0342DbMFaHKmImhL0q7VHj.png)

④容器限制界面暂时没有东西需要修改

![PixPin_2026-02-24_20-01-01.png](https://pic1.imgdb.cn/i/0342DbKNHx99zvFn0iURgF.png)
...
![PixPin_2026-02-24_20-31-14.png](https://pic1.imgdb.cn/i/0342DbMLEV9ZXMSEuU7M1S.png)
