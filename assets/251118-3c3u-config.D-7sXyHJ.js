import{Bt as e,Ht as t,Q as n,U as r,W as i,er as a,qn as o,qt as s,yn as c}from"./framework.BTQirQJB.js";import{n as l}from"./theme.8JZ-ZCgZ.js";import"./chunks/vue-i18n.C1-1dNXk.js";import{a as u,i as d}from"./chunks/vue-router.YUHqddSK.js";var f={__name:`251118-3c3u-config`,setup(f,{expose:p}){let m=o(JSON.parse(`{"title":"3C3U-金萝卜组织文档壹","description":"搞钱，迎娶白富美，走上人生巅峰。","frontmatter":{"description":"搞钱，迎娶白富美，走上人生巅峰。","title":"3C3U-金萝卜组织文档壹","date":"2025-11-18","categories":["游戏"],"tags":["3c3u.org","无规则服","minecraft"],"codeHeightLimit":300,"firstImage":"https://pic1.imgdb.cn/i/0342DZhW2RsFI5kPQYYhBk.png"},"headers":[],"relativePath":"pages/posts/251118-3c3u-config.md"}`)),h=u(),g=d(),_=Object.assign(g.meta.frontmatter||{},m.value?.frontmatter||{});return h.currentRoute.value.data=m.value,t(`valaxy:frontmatter`,_),globalThis.$frontmatter=_,p({frontmatter:{description:`搞钱，迎娶白富美，走上人生巅峰。`,title:`3C3U-金萝卜组织文档壹`,date:`2025-11-18`,categories:[`游戏`],tags:[`3c3u.org`,`无规则服`,`minecraft`],codeHeightLimit:300}}),(t,o)=>{let u=l;return e(),i(u,{frontmatter:a(_)},{"main-content-md":c(()=>[...o[0]||=[r(`ul`,null,[r(`li`,null,`无规则服`),r(`li`,null,`minecraft`)],-1),r(`hr`,null,null,-1),r(`h2`,{id:`_3c3u-mcc命令行客户端-​`,tabindex:`-1`},[n(`3C3U-MCC命令行客户端 `),r(`a`,{href:`#_3c3u-mcc%E5%91%BD%E4%BB%A4%E8%A1%8C%E5%AE%A2%E6%88%B7%E7%AB%AF`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#_3c3u-mcc命令行客户端-​`,"aria-label":`Permalink to "3C3U-MCC命令行客户端 [​](#_3c3u-mcc命令行客户端)"`},`​`)],-1),r(`blockquote`,null,[r(`p`,null,`本篇文章将介绍金萝卜使用的命令行客户端，后台控制，链接等。`)],-1),r(`p`,null,`目前本基地有正式成员4人。`,-1),r(`p`,null,[n(`空闲用于挂机账号多个，详情见`),r(`a`,{href:`#%E9%99%84`},`附`),n(`。`)],-1),r(`p`,null,[n(`目前本人`),r(`a`,{href:`https://www.hebaiju.cn/`,target:`_blank`,rel:`noreferrer`},`HEBAIJU`),n(`购买服务器用来运行机器人，在想办法节约成本。故会根据服务器的价格来随时更换服务器。你可以点击下面链接进行跳转`)],-1),r(`table`,null,[r(`thead`,null,[r(`tr`,null,[r(`th`,null,`第一台`),r(`th`,null,`第二台`)])]),r(`tbody`,null,[r(`tr`,null,[r(`td`,null,[r(`a`,{href:`http://f.hebaiju.cn:23333/`,target:`_blank`,rel:`noreferrer`},`付费服🎮`)]),r(`td`,null,[r(`a`,{href:`https://mcsm.rainyun.com/`,target:`_blank`,rel:`noreferrer`},`签到免费服🎮`)])])])],-1),r(`h2`,{id:`当前情况-​`,tabindex:`-1`},[n(`当前情况 `),r(`a`,{href:`#%E5%BD%93%E5%89%8D%E6%83%85%E5%86%B5`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#当前情况-​`,"aria-label":`Permalink to "当前情况 [​](#当前情况)"`},`​`)],-1),r(`p`,null,[n(`当前可用服务器共计2台，都使用`),r(`a`,{href:`https://docs.mcsmanager.com/`,target:`_blank`,rel:`noreferrer`},`MCSManager Panel`),n(`管理。但是因为不同的原因当前只能使用两台。且应为3C的限制一个IP只能同时登陆3个账号！`)],-1),r(`p`,null,[n(`第一台：`),r(`a`,{href:`http://61.174.242.144:23333/`,target:`_blank`,rel:`noreferrer`},`MCSManager Panel`),n(` 。`),r(`strong`,null,`完全能用`),n(`。此服务器为主服务器，目前正在使用，`)],-1),r(`p`,null,[r(`strong`,null,`第一台`),n(`服务器内有多个机器人，每个机器人都有一个独立的账号。使用管理账号均能使用。但是注意配置文件，稍后我会详细说明。有多个终端，但是最多在3C中运行3个挂机账号，应为3C限制每个ip登陆3个账号。需要管理员账号给我发信息。`)],-1),r(`p`,null,[n(`第二台：`),r(`a`,{href:`https://mcsm.rainyun.com/`,target:`_blank`,rel:`noreferrer`},`MCSManager Panel`),n(`。`),r(`strong`,null,`一般能用`),n(`。此服务器可以使用，应为是免费的服务器面板，故此只能运行一个机器人，但是服务器出于大厂非常稳定。`)],-1),r(`p`,null,[r(`strong`,null,`第二台`),n(`服务器是来自`),r(`a`,{href:`https://app.rainyun.com/`,target:`_blank`,rel:`noreferrer`},`雨云`),n(`。的免费面板服，原先的作用是来开mc服务器，但是我的修改后成为了一个挂机的服务器，但是只有一个终端，所以只能运行一个机器人。`)],-1),r(`p`,null,`上述为所有服务器的基本情况。`,-1),r(`table`,null,[r(`thead`,null,[r(`tr`,null,[r(`th`,null,`表格对比`),r(`th`,null,`第一台`),r(`th`,null,`第二台`)])]),r(`tbody`,null,[r(`tr`,null,[r(`td`,null,`是否能用`),r(`td`,null,`yes`),r(`td`,null,`yes`)]),r(`tr`,null,[r(`td`,null,`可以在线多少`),r(`td`,null,`3`),r(`td`,null,`1`)]),r(`tr`,null,[r(`td`,null,`价格`),r(`td`,null,`HEBAIJU在续费`),r(`td`,null,[n(`免费，但是需要`),r(`a`,{href:`https://app.rainyun.com/account/reward/earn#`,target:`_blank`,rel:`noreferrer`},`签到`)])]),r(`tr`,null,[r(`td`,null,`服务器位置`),r(`td`),r(`td`,null,`宿迁`)])])],-1),r(`p`,null,`以上为2台服务器的基本信息`,-1),r(`h2`,{id:`第一台服务器-​`,tabindex:`-1`},[n(`第一台服务器 `),r(`a`,{href:`#%E7%AC%AC%E4%B8%80%E5%8F%B0%E6%9C%8D%E5%8A%A1%E5%99%A8`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第一台服务器-​`,"aria-label":`Permalink to "第一台服务器 [​](#第一台服务器)"`},`​`)],-1),r(`p`,null,[r(`a`,{href:`http://61.174.242.144:23333/`,target:`_blank`,rel:`noreferrer`},`第一台服务器MCSManager Panel`),n(` 。`),r(`strong`,null,`完全能用`),n(`。我拥有此服务器的管理员权限，面板我也能给与管理员权限。服务器将由我进行续费，和维护。你们不用操心。此服务器为主服务器，目前正在使用，相对来书比较理想的服务器，但是他的服务商`),r(`strong`,null,`比较容易跑路`),n(`，因此我可能会随时更换掉，可以访问当前页面进行跳转。`)],-1),r(`h3`,{id:`第一步-登陆-​`,tabindex:`-1`},[n(`第一步：登陆 `),r(`a`,{href:`#%E7%AC%AC%E4%B8%80%E6%AD%A5-%E7%99%BB%E9%99%86`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第一步-登陆-​`,"aria-label":`Permalink to "第一步：登陆 [​](#第一步-登陆)"`},`​`)],-1),r(`p`,null,[n(`点击当前页面上`),r(`a`,{href:`http://61.174.242.144:23333/`,target:`_blank`,rel:`noreferrer`},`这个链接`),n(`进入服务器控制台:`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZhW2RsFI5kPQYYhBk.png`,alt:`1登陆`,loading:`lazy`,decoding:`async`})],-1),r(`p`,null,`联系我获取这里的密码，然后去登陆面板控制`,-1),r(`h3`,{id:`第二步-选择实例-​`,tabindex:`-1`},[n(`第二步：选择实例 `),r(`a`,{href:`#%E7%AC%AC%E4%BA%8C%E6%AD%A5-%E9%80%89%E6%8B%A9%E5%AE%9E%E4%BE%8B`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第二步-选择实例-​`,"aria-label":`Permalink to "第二步：选择实例 [​](#第二步-选择实例)"`},`​`)],-1),r(`p`,null,`输入账号密码后直接进入控制面板页面，上面是管理员账户，所有面板非常丰富。`,-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZhII4tndrZKvCbK7S.png`,alt:`选择实例1`,loading:`lazy`,decoding:`async`})],-1),r(`p`,null,`如图所示，你可以随意去点击，进入任意一个实例终端`,-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZhIgD1z89G4dPscNq.png`,alt:`选择实例2`,loading:`lazy`,decoding:`async`})],-1),r(`p`,null,`一般情况下你只用点击这里的开启按钮，或者关闭按钮，因为里面的所有配置我已经配置好了。下面红色方块内的为一些其他的功能，可以管理文件，对终端进行设置，或者一些其他的……`,-1),r(`h3`,{id:`第三步-文件管理-​`,tabindex:`-1`},[n(`第三步：文件管理 `),r(`a`,{href:`#%E7%AC%AC%E4%B8%89%E6%AD%A5-%E6%96%87%E4%BB%B6%E7%AE%A1%E7%90%86`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第三步-文件管理-​`,"aria-label":`Permalink to "第三步：文件管理 [​](#第三步-文件管理)"`},`​`)],-1),r(`p`,null,[n(`点击上图中下方的`),r(`strong`,null,`文件管理`),n(`按钮，文件管理里面可以查看例如：日志文件，配置文件等。`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZhWEE5eFhMrXxFaXR.png`,alt:`3文件管理`,loading:`lazy`,decoding:`async`})],-1),r(`p`,null,`如图所示其中有很多文件，我将一一介绍：`,-1),r(`ul`,null,[r(`li`,null,[r(`p`,null,`Sentry：这个是用于机器人的UUID，不用管`)]),r(`li`,null,[r(`p`,null,`lang：这个是服务器的翻译配置文件，里面有一个zh_cn.json。`)]),r(`li`,null,[r(`p`,null,`3c3u-log.txt：这个是服务器消息日志文件。用于记录聊天成就等信息。可以在配置文件里面开启或者关闭，或者`)]),r(`li`,null,[r(`p`,null,`MinecraftClient-20250522-285-linux-x64：机器人本体。`)]),r(`li`,null,[r(`p`,null,`MinecraftClient.backup.ini:机器人配置文件备份，若配置损坏则读取这个。`)]),r(`li`,null,[r(`p`,null,[n(`MinecraftClient.ini：机器人配置文件，优先读取，可以修改，但是记得备份。点击`),r(`a`,{href:`https://mccteam.github.io/l10n/zh-Hans/guide/`,target:`_blank`,rel:`noreferrer`},`Minecraft 命令行客户端`),n(`查看详细配置。`)])]),r(`li`,null,[r(`p`,null,`core：这个我也不知道是干什么的。`)]),r(`li`,null,[r(`p`,null,`启动脚本(可修改).sh：启动文件，切记不要改名字。`),r(`p`,null,`启动脚本解释：./MinecraftClient-20250522-285-linux-x64 jb_19CM`),r(`p`,null,`”./“执行当前目录下的MinecraftClient-20250522-285-linux-x64文件，"jb_19CM"启动参数，需要进入游戏的用户名。`),r(`blockquote`,null,[r(`p`,null,`启动脚本是第二台服务器的第十步里面特有的文件`)])])],-1),r(`h3`,{id:`第四步-实例设置-​`,tabindex:`-1`},[n(`第四步：实例设置 `),r(`a`,{href:`#%E7%AC%AC%E5%9B%9B%E6%AD%A5-%E5%AE%9E%E4%BE%8B%E8%AE%BE%E7%BD%AE`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第四步-实例设置-​`,"aria-label":`Permalink to "第四步：实例设置 [​](#第四步-实例设置)"`},`​`)],-1),r(`p`,null,`上述步骤看完之后，返回上一个页面，进入实例设置页面。`,-1),r(`p`,null,[n(`这里`),r(`strong`,null,`最重要`),n(`的是`),r(`strong`,null,`启动命令`),n(`，等同于第三步的最后一个文件命令，`)],-1),r(`div`,{class:`language- max-h-300px`},[r(`button`,{title:`Copy code`,class:`copy`}),r(`span`,{class:`lang`}),r(`pre`,{class:`shiki shiki-themes github-light github-dark vp-code`},[r(`code`,{"v-pre":``},[r(`span`,{class:`line`},[r(`span`,null,`./MinecraftClient-20250522-285-linux-x64 WDddl`)])])]),r(`button`,{class:`code-block-unfold-btn`})],-1),r(`p`,null,`含义：“./”执行当前目录下的“MinecraftClient-20250522-285-linux-x64文件”，启动用户名是"WDddl"。一般不用修改。`,-1),r(`p`,null,`注意`,-1),r(`p`,null,`记得在文件管理里面给MinecraftClient-20250522-285-linux-x64添加可执行权限`,-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZhXaxQ7y3ZdHaxlbp.png`,alt:`1.4实例设置`,loading:`lazy`,decoding:`async`})],-1),r(`h2`,{id:`第二台服务器-​`,tabindex:`-1`},[n(`第二台服务器 `),r(`a`,{href:`#%E7%AC%AC%E4%BA%8C%E5%8F%B0%E6%9C%8D%E5%8A%A1%E5%99%A8`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第二台服务器-​`,"aria-label":`Permalink to "第二台服务器 [​](#第二台服务器)"`},`​`)],-1),r(`p`,null,[n(`其中最重要的是`),r(`strong`,null,`第二台`),n(`服务器，`),r(`strong`,null,`第二台`),n(`服务器是来自`),r(`a`,{href:`https://app.rainyun.com/`,target:`_blank`,rel:`noreferrer`},`雨云`),n(`的免费游戏面板服，原先的作用是来开mc服务器，但是我的修改后成为了一个可以挂机的服务器，但是只有一个Docker终端，所以只能运行一个机器人。`)],-1),r(`p`,null,`它出于服务商雨云，基本不会跑路。`,-1),r(`p`,null,[r(`a`,{href:`https://app.rainyun.com/`,target:`_blank`,rel:`noreferrer`},`雨云`),n(`此服务器采用签到付费，`),r(`a`,{href:`https://app.rainyun.com/account/reward/earn#`,target:`_blank`,rel:`noreferrer`},`签到`),n(`每天可以获得500积分，服务器续费一个月需要10000积分。所有需要在一个月内至少签到`),r(`strong`,null,`20天`),n(`。`)],-1),r(`blockquote`,null,[r(`p`,null,`下面是签到的图，如果我漏签了麻烦帮忙签到一下。`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZl0LEsv6AwdgubNeY.png`,alt:`2.2.1签到`,loading:`lazy`,decoding:`async`})],-1),r(`h3`,{id:`第一步-登陆-​-1`,tabindex:`-1`},[n(`第一步：登陆 `),r(`a`,{href:`#%E7%AC%AC%E4%B8%80%E6%AD%A5-%E7%99%BB%E9%99%86-1`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第一步-登陆-​-1`,"aria-label":`Permalink to "第一步：登陆 [​](#第一步-登陆-1)"`},`​`)],-1),r(`p`,null,[r(`a`,{href:`https://app.rainyun.com/account/reward/earn#`,target:`_blank`,rel:`noreferrer`},`点击该链接`),n(`直接进入`),r(`a`,{href:`https://app.rainyun.com/`,target:`_blank`,rel:`noreferrer`},`雨云`),n(`的官网。登陆后自动跳转到签到页面。如下图是登陆页面。`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZmZ2grPjTAFXSuiDq.png`,alt:`2.1.1登陆`,loading:`lazy`,decoding:`async`})],-1),r(`p`,null,`联系我获取这里雨云的密码，然后去登陆控制`,-1),r(`h3`,{id:`第二步-签到-​`,tabindex:`-1`},[n(`第二步：签到 `),r(`a`,{href:`#%E7%AC%AC%E4%BA%8C%E6%AD%A5-%E7%AD%BE%E5%88%B0`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第二步-签到-​`,"aria-label":`Permalink to "第二步：签到 [​](#第二步-签到)"`},`​`)],-1),r(`p`,null,`填写账号密码信息，点击登陆按钮后会直接跳转到如下图签到页面`,-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZl0LEsv6AwdgubNeY.png`,alt:`2.2.1签到`,loading:`lazy`,decoding:`async`})],-1),r(`h3`,{id:`第三步-人机验证-​`,tabindex:`-1`},[n(`第三步：人机验证 `),r(`a`,{href:`#%E7%AC%AC%E4%B8%89%E6%AD%A5-%E4%BA%BA%E6%9C%BA%E9%AA%8C%E8%AF%81`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第三步-人机验证-​`,"aria-label":`Permalink to "第三步：人机验证 [​](#第三步-人机验证)"`},`​`)],-1),r(`p`,null,[n(`点击（`),r(`strong`,null,`领取奖励`),n(`）按钮则会弹出腾讯公司的人机验证（由于此人机校验码的难度太高，我没能实现自动验证登陆）。`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZl97J0MSu7VrRZccU.png`,alt:`2.3.1人机验证`,loading:`lazy`,decoding:`async`})],-1),r(`h3`,{id:`第四步-积分反馈-​`,tabindex:`-1`},[n(`第四步：积分反馈 `),r(`a`,{href:`#%E7%AC%AC%E5%9B%9B%E6%AD%A5-%E7%A7%AF%E5%88%86%E5%8F%8D%E9%A6%88`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第四步-积分反馈-​`,"aria-label":`Permalink to "第四步：积分反馈 [​](#第四步-积分反馈)"`},`​`)],-1),r(`p`,null,[n(`完成人机验证，随后就可以看到下图红框中的积分增加了`),r(`strong`,null,`500`),n(`分。领取奖励的按钮成为灰色则签到成功。`)],-1),r(`p`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZmlub8wkuSA147qII.png`,alt:`2.4.1积分`}),r(`img`,{src:`https://pic1.imgdb.cn/i/0342DZkVvli0zQA4RKVbvl.png`,alt:`2.4.2积分`})],-1),r(`h3`,{id:`第五步-续费-​`,tabindex:`-1`},[n(`第五步：续费 `),r(`a`,{href:`#%E7%AC%AC%E4%BA%94%E6%AD%A5-%E7%BB%AD%E8%B4%B9`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第五步-续费-​`,"aria-label":`Permalink to "第五步：续费 [​](#第五步-续费)"`},`​`)],-1),r(`p`,null,[n(`之后就可以点击`),r(`a`,{href:`https://app.rainyun.com/apps/rgs/65489/detail`,target:`_blank`,rel:`noreferrer`},`免费续费`),n(`来对服务器进行续费。`)],-1),r(`p`,null,`橙色框内有续费的要求*（有些要求是正常的，毕竟免费的是最贵的嘛！）*`,-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DbMEtehOHhi2FIY5vJ.png`,alt:`2.5.1续费`,loading:`lazy`,decoding:`async`})],-1),r(`h3`,{id:`第六步-获取密码-​`,tabindex:`-1`},[n(`第六步：获取密码 `),r(`a`,{href:`#%E7%AC%AC%E5%85%AD%E6%AD%A5-%E8%8E%B7%E5%8F%96%E5%AF%86%E7%A0%81`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第六步-获取密码-​`,"aria-label":`Permalink to "第六步：获取密码 [​](#第六步-获取密码)"`},`​`)],-1),r(`p`,null,[n(`密码的获取：`),r(`a`,{href:`https://app.rainyun.com/apps/rgs/list`,target:`_blank`,rel:`noreferrer`},`下滑`),n(`页面可以看如下图的的管理面板窗口，在这里面来获取你的账号`),r(`a`,{href:`https://app.rainyun.com/apps/rgs/list`,target:`_blank`,rel:`noreferrer`},`密码`),n(`在下一步进行面版的登陆管理。`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DbMHR0SAkFzjHndo67.png`,alt:`2.6.1密码`,loading:`lazy`,decoding:`async`})],-1),r(`h3`,{id:`第七步-登陆面板-​`,tabindex:`-1`},[n(`第七步：登陆面板 `),r(`a`,{href:`#%E7%AC%AC%E4%B8%83%E6%AD%A5-%E7%99%BB%E9%99%86%E9%9D%A2%E6%9D%BF`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第七步-登陆面板-​`,"aria-label":`Permalink to "第七步：登陆面板 [​](#第七步-登陆面板)"`},`​`)],-1),r(`p`,null,[n(`可以如上图所示点击`),r(`a`,{href:`https://mcsm.rainyun.com/#/login`,target:`_blank`,rel:`noreferrer`},`（进入控制台(MCSM)）`),n(`，再输入上图获取的密码，对面板服务器进行管理。如下图所示。`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DbJGxCHGWNt4RU8pKW.png`,alt:`2.7.1面板登陆`,loading:`lazy`,decoding:`async`})],-1),r(`h3`,{id:`第八步-登陆控制台-​`,tabindex:`-1`},[n(`第八步：登陆控制台 `),r(`a`,{href:`#%E7%AC%AC%E5%85%AB%E6%AD%A5-%E7%99%BB%E9%99%86%E6%8E%A7%E5%88%B6%E5%8F%B0`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第八步-登陆控制台-​`,"aria-label":`Permalink to "第八步：登陆控制台 [​](#第八步-登陆控制台)"`},`​`)],-1),r(`p`,null,`点击登陆按钮后，如下图页面，再点击进入控制台。`,-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DbJ5FrRuHm82QGYmnt.png`,alt:`2.8.1管理面板`,loading:`lazy`,decoding:`async`})],-1),r(`h3`,{id:`第九步-控制台管理-​`,tabindex:`-1`},[n(`第九步：控制台管理 `),r(`a`,{href:`#%E7%AC%AC%E4%B9%9D%E6%AD%A5-%E6%8E%A7%E5%88%B6%E5%8F%B0%E7%AE%A1%E7%90%86`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第九步-控制台管理-​`,"aria-label":`Permalink to "第九步：控制台管理 [​](#第九步-控制台管理)"`},`​`)],-1),r(`p`,null,`这个时候你就完全登陆进来了，里面所有的东西都可以操作，服务器的开启或者关闭等等一切。`,-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DbJZThzHT3hWBPOcHq.png`,alt:`2.9.1控制台`,loading:`lazy`,decoding:`async`})],-1),r(`p`,null,`一般情况下点击关闭按钮就能直接关闭，如果遇到故障则点击终止按钮。`,-1),r(`h3`,{id:`第十步-文件管理-​`,tabindex:`-1`},[n(`第十步：文件管理 `),r(`a`,{href:`#%E7%AC%AC%E5%8D%81%E6%AD%A5-%E6%96%87%E4%BB%B6%E7%AE%A1%E7%90%86`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#第十步-文件管理-​`,"aria-label":`Permalink to "第十步：文件管理 [​](#第十步-文件管理)"`},`​`)],-1),r(`p`,null,[n(`在下方有`),r(`strong`,null,`文件管理`),n(`按钮，里面可以查看例如：日志文件，配置文件等。`)],-1),r(`figure`,null,[r(`img`,{src:`https://pic1.imgdb.cn/i/0342DbKZxQSTZxzeHiIyus.png`,alt:`2.10.1文件管理`,loading:`lazy`,decoding:`async`})],-1),r(`p`,null,`如图所示其中有很多文件，我这里于第一台服务器的第三步骤完全相同。点击旁边目录跳转。`,-1),r(`h2`,{id:`最后-​`,tabindex:`-1`},[n(`最后 `),r(`a`,{href:`#%E6%9C%80%E5%90%8E`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#最后-​`,"aria-label":`Permalink to "最后 [​](#最后)"`},`​`)],-1),r(`p`,null,`服务器面板的控制方法大同小异，随便看看就会使用了，如果有需要请给我发信息。`,-1),r(`p`,null,`综上所述，目前共有2台服务器，我会尽力去续费，愿游玩的开心。最后感谢我的小伙伴们。`,-1),r(`h2`,{id:`附-​`,tabindex:`-1`},[n(`附： `),r(`a`,{href:`#%E9%99%84`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#附-​`,"aria-label":`Permalink to "附： [​](#附)"`},`​`)],-1),r(`h3`,{id:`挂机机器人详细配置-​`,tabindex:`-1`},[n(`挂机机器人详细配置 `),r(`a`,{href:`#_2-%E6%8C%82%E6%9C%BA%E6%9C%BA%E5%99%A8%E4%BA%BA%E8%AF%A6%E7%BB%86%E9%85%8D%E7%BD%AE`},`​`),n(),r(`a`,{class:`header-anchor`,href:`#挂机机器人详细配置-​`,"aria-label":`Permalink to "挂机机器人详细配置 [​](#_2-挂机机器人详细配置)"`},`​`)],-1),r(`p`,null,[n(`你可以访问`),r(`a`,{href:`https://mccteam.github.io/l10n/zh-Hans/guide/`,target:`_blank`,rel:`noreferrer`},`Minecraft 命令行客户端`),n(`来查看更加详细的配置。`)],-1),r(`div`,{class:`language- max-h-300px`},[r(`button`,{title:`Copy code`,class:`copy`}),r(`span`,{class:`lang`}),r(`pre`,{class:`shiki shiki-themes github-light github-dark vp-code`},[r(`code`,{"v-pre":``},[r(`span`,{class:`line`},[r(`span`,null,`# 启动配置文件`)]),n(`
...
`),r(`span`,{class:`line`},[r(`span`,null,`AllowIpAlias = false                        # 允许 IP 别名，如 "localhost"；如果使用容器，则可以使用容器名称...`)])])]),r(`button`,{class:`code-block-unfold-btn`})],-1)]]),"main-header":c(()=>[s(t.$slots,`main-header`)]),"main-header-after":c(()=>[s(t.$slots,`main-header-after`)]),"main-nav":c(()=>[s(t.$slots,`main-nav`)]),"main-content-before":c(()=>[s(t.$slots,`main-content-before`)]),"main-content":c(()=>[s(t.$slots,`main-content`)]),"main-content-after":c(()=>[s(t.$slots,`main-content-after`)]),"main-nav-before":c(()=>[s(t.$slots,`main-nav-before`)]),"main-nav-after":c(()=>[s(t.$slots,`main-nav-after`)]),comment:c(()=>[s(t.$slots,`comment`)]),footer:c(()=>[s(t.$slots,`footer`)]),aside:c(()=>[s(t.$slots,`aside`)]),"aside-custom":c(()=>[s(t.$slots,`aside-custom`)]),default:c(()=>[s(t.$slots,`default`)]),_:3},8,[`frontmatter`])}}};export{f as default};