import{_ as b}from"./ValaxyMain.vue_vue_type_style_index_0_lang.CtPztCxX.js";import"./chunks/@vueuse/motion.azCphnVb.js";import{e as _,u as C,a as g}from"./chunks/vue-router.BSuMaXH7.js";import{aa as S,al as a,ag as p,af as n,ai as l,W as r,a9 as h,F as k,ab as E,Z as F}from"./framework.Dh18Cujy.js";import"./app.B7zItxc6.js";import"./chunks/dayjs.BdcnXKr1.js";import"./chunks/vue-i18n.DrqRw-jk.js";import"./chunks/pinia.Rnot4_r4.js";/* empty css                    */import"./chunks/nprogress.Bru8d7fl.js";import"./YunComment.vue_vue_type_style_index_0_lang.BNGoA5bc.js";import"./index.C5okkQwF.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang.BE7ialfa.js";import"./post.C2xqCH_S.js";const B={class:"warning custom-block"},v={class:"custom-block-title custom-block-title-default"},A={class:"warning custom-block"},x={class:"custom-block-title custom-block-title-default"},M=_("/posts/251207-ESP8266AC-IR-Control",async i=>JSON.parse('{"title":"ESP8266控制空调","description":"","frontmatter":{"title":"ESP8266控制空调","date":"2025-12-9","updated":"2025-12-9","categories":"Code","icon":"i-ri-snowflake-fill","tags":["编程","ESP8266","项目"],"time_warning":"true | 3600000","draft":false,"hide":false,"codeHeightLimit":600},"headers":[],"relativePath":"pages/posts/251207-ESP8266AC-IR-Control.md","lastUpdated":null}'),{lazy:(i,t)=>i.name===t.name}),q={__name:"251207-ESP8266AC-IR-Control",setup(i,{expose:t}){const{data:o}=M(),d=g(),m=C(),c=Object.assign(m.meta.frontmatter||{},o.value?.frontmatter||{});return d.currentRoute.value.data=o.value,F("valaxy:frontmatter",c),globalThis.$frontmatter=c,t({frontmatter:{title:"ESP8266控制空调",date:"2025-12-9",updated:"2025-12-9",categories:"Code",icon:"i-ri-snowflake-fill",tags:["编程","ESP8266","项目"],time_warning:"true | 3600000",draft:!1,hide:!1,codeHeightLimit:600}}),(e,s)=>{const u=h("VT"),f=b;return E(),S(f,{frontmatter:k(c)},{"main-content-md":a(()=>[s[4]||(s[4]=n("h2",{id:"项目介绍",tabindex:"-1"},[l("项目介绍 "),n("a",{class:"header-anchor",href:"#项目介绍","aria-label":'Permalink to "项目介绍"'},"​")],-1)),s[5]||(s[5]=n("p",null,[l("本文章基于ESP8266开发板来实现对空调的控制，基本控制原理为，通过点灯科技APP向ESP8266来发送指令，ESP8266通过库来实现对红外LED的编码控制，从而实现对空调的控制。可以查看上一篇文章"),n("a",{href:"./251013-ESP8266DormitorySmartDoor"},"「宿舍智能门」 - 鹤白居的小站")],-1)),s[6]||(s[6]=n("p",null,[l("此项目源代码来源于B站博主"),n("a",{href:"https://space.bilibili.com/107884665",target:"_blank",rel:"noreferrer"},"DIY大白"),l("的视频"),n("a",{href:"https://www.bilibili.com/video/BV1JE411J77j/?share_source=copy_web&vd_source=c1934f3384f795e39369baf360bcb94c",target:"_blank",rel:"noreferrer"},"ESP8266红外遥控格力空调"),l("。首先感谢博主的开源精神，我将基于该原博主进行代码升级和功能优化。")],-1)),s[7]||(s[7]=n("hr",null,null,-1)),s[8]||(s[8]=n("h2",{id:"开始",tabindex:"-1"},[l("开始 "),n("a",{class:"header-anchor",href:"#开始","aria-label":'Permalink to "开始"'},"​")],-1)),s[9]||(s[9]=n("h2",{id:"材料准备",tabindex:"-1"},[l("材料准备 "),n("a",{class:"header-anchor",href:"#材料准备","aria-label":'Permalink to "材料准备"'},"​")],-1)),s[10]||(s[10]=n("table",null,[n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"center"}},"名称"),n("th",{style:{"text-align":"center"}},"数量")])]),n("tbody",null,[n("tr",null,[n("td",{style:{"text-align":"center"}},"ESP8266"),n("td",{style:{"text-align":"center"}},"1")]),n("tr",null,[n("td",{style:{"text-align":"center"}},"红外LED"),n("td",{style:{"text-align":"center"}},"1")]),n("tr",null,[n("td",{style:{"text-align":"center"}},"杜邦线"),n("td",{style:{"text-align":"center"}},"若干")])])],-1)),s[11]||(s[11]=n("p",null,"注意需要红外LED，分辨方法，通电之后肉眼看不见白光，而是只能使用手机摄像头能看见微弱的红光。",-1)),s[12]||(s[12]=n("p",null,[l("当然你仍然可以基于以前的"),n("a",{href:"https://www.hebaiju.cn/posts/251013-ESP8266DormitorySmartDoor",target:"_blank",rel:"noreferrer"},"开源项目-「宿舍智能门」 - 鹤白居的小站"),l("来继续在被控制端进行增加功能。这一次将使用RX引脚，兼容之前的项目。复用了这一段端口")],-1)),s[13]||(s[13]=n("h2",{id:"接线方法",tabindex:"-1"},[l("接线方法 "),n("a",{class:"header-anchor",href:"#接线方法","aria-label":'Permalink to "接线方法"'},"​")],-1)),s[14]||(s[14]=n("p",null,[l("红外LED长针连接ESP8266的RX引脚如下图的 "),n("strong",null,"7 GPIO3 U0RXD"),l(",短针连接在GND。")],-1)),s[15]||(s[15]=n("img",{src:"https://preview.cloud.189.cn/image/imageAction?param=0CB391B46FCE1A0BCE39D46EC1E923811E494B149F72517EEFA59DB3ACD86FA41864B16A5AE42E46229F883E8BCDDBA7133C7EFF713969A5FAA234C10FCE9C848A4FAFB695B601DB21DEE136B58F4B2943EFEB0D4FC78F20D558E55A3E0D0BBDD88BD3CFF8709495877BF007E04E7FC028EA314A",alt:"ESP826601s引脚",style:{zoom:"50%"}},null,-1)),s[16]||(s[16]=n("img",{src:"https://preview.cloud.189.cn/image/imageAction?param=9C69CF47C0F2002D0E14EF4E6C3FE604AC44497B554A954C651336D2EED7D11F99D20D3858413D595A47B84907602EE87B33452B8A7E0B7079C88D8371AE9F36D719570D220F72F5CE987F1E0423EB175E56F871DBFF878D613B35D1476F309F33A61B504A7DBD579C645293134D494F3EFDC5D0",alt:"ESP8266引脚",style:{zoom:"50%"}},null,-1)),s[17]||(s[17]=n("h2",{id:"测试代码",tabindex:"-1"},[l("测试代码 "),n("a",{class:"header-anchor",href:"#测试代码","aria-label":'Permalink to "测试代码"'},"​")],-1)),s[18]||(s[18]=n("p",null,"接下来，你就可以连接上电脑来刷写下面的测试代码，来测试是否能够点亮led",-1)),s[19]||(s[19]=n("p",null,"你通过串口需要向esp8266发送字符串 on 或者 off，然后通过手机摄像头，对准led观察是否有红色的闪光。多测试几次",-1)),s[20]||(s[20]=n("p",null,"当然你先需要安装下面的库文件。有疑问可以复制发送给ai，咨询什么是库文件，怎么安装，这里不做阐述。",-1)),n("div",B,[n("p",v,[r(u,{content:"blocks.warning"})]),s[0]||(s[0]=n("p",null,"注意应为复用RX引脚，所以在下述刷代码的时候请不要连接任何设备在GPIO3，否则刷写不成功。",-1))]),s[21]||(s[21]=n("div",{class:"language- max-h-600px"},[n("button",{title:"Copy code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code"},[n("code",{"v-pre":""},[n("span",{class:"line"},[n("span",null,"// 红外灯的测试配置")]),l(`
...
`),n("span",{class:"line"},[n("span",null,'const char AUTH[] = "";                         //电灯科技密钥测试')]),l(`
`),n("span",{class:"line"},[n("span",null,'// const char AUTH[] = "";'),n("span",null,"                      //电灯科技密钥正式")]),l(`
`),n("span",{class:"line"},[n("span",null,'const char WIFI_SSID[] = "";                    //WIFI名称')]),l(`
`),n("span",{class:"line"},[n("span",null,'const char WIFI_PSWD[] = "";                    //WIFI密码')]),l(`
`),n("span",{class:"line"},[n("span",null,'const char* CUSTOM_HOSTNAME = "开门猫";          //设备名称')]),l(`
`),n("span",{class:"line"},[n("span",null,'const char* mqtt_server = "";                   //mqtt服务器')]),l(`
`),n("span",{class:"line"},[n("span",null,"const int mqtt_port = 1883;                     //mqtt端口")]),l(`
`),n("span",{class:"line"},[n("span",null,'const char* mqtt_topic = "switch/state";        //mqtt主题订阅')]),l(`
`),n("span",{class:"line"},[n("span")]),l(`
